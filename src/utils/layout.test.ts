...
describe('distributePlayers', () => {
  ...
  it('should respect myPlayerIndex for client perspective', () => {
    ...
    expect(distributePlayers(4, 1)).toEqual({ top: [3], left: 2, right: 0 })
  })
  ...
  it('should handle client as last player', () => {
    ...
    expect(distributePlayers(4, 3)).toEqual({ top: [1], left: 0, right: 2 })
  })
})
